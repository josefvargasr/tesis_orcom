...
public:
	...
	/*
		Función:
			Recorre un buffer del archivo Fastq recolectando partes del mismo para procesarlas posteriormente
		Entradas: 
			chunk_: Buffer con partes del archivo Fastq
		Salida:
			bool: Define si el buffer está vacío
	*/
...
public:
	...
	/*
		Función:
			Abre el archivo fastq para su posterior lectura
		Entradas: 
			fileNames_: Nombre del archivo fastq a leer
	*/
...
public:
	...
	/*
		Función:
			Abre el archivo fastq comprimido para su posterior lectura
		Entradas: 
			fileNames_: Nombre del archivo fastq a leer
	*/
