...
class DnaBin : public TConstCollection<DnaRecord>	// Vector de estructuras DnaRecord
{
public:
	DnaBin()
		:	DnaColection(0)
...
typedef TConstPtrCollection<DnaBin> DnaBinCollection;	//Vector de objetos DnaBin
