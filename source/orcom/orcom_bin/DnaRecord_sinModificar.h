...
struct DnaRecord
{
	...
	char* dna;								// 8B	// Es la variable que almacena el Read como cadena de caracteres
	uint16 len;								// 2B	// Longitud del Read
	uint8 minimizerPos;						// 1B	// 
	bool reverse;							// 1B	// Indica si es el complemento reverso del Read
	//
	...
	/*
		Función:
			Encuentra el complemento inverso del Read en el objeto rec_
		Entradas: 
			rc_: Objeto DnaRecord que contiene el Read a intervenir
	*/
};
